...
~~~sh
# getting the code
git clone git@github.com:nko5/all-your-javascripts.git && cd ./all-your-javascripts/
...
# deploying to Modulus (to http://all-your-javascripts.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/all-your-javascripts" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
